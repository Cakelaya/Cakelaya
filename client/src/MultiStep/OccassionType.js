...
const OccassionType = ({ prevStep, nextStep, values, handleChange }) => {
  // console.log(values);
  ...
  const Continue = (e) => {
    e.preventDefault();
    if (color1 == false && color2 == false && color3 == false) {
