...
const Cart = () => {
  ...
  useEffect(() => {
    const getProducts = async () => {
      try {
        ...
        if(city=="Sultanpur"){
          setProducts(res.data.filter((prod)=>{
  ...
  //     name: "Cakeलाया",
  //     description: "At it's best price",
  //     image: "images/favicon.jpg",
  //     order_id: data.id,
  //     handler: async (response) => {
  //       try {
  //         const verifyUrl = "https://cakelaya.com/api/checkout/verify";
  ...
  //   try {
  //     const orderUrl = "https://cakelaya.com/api/checkout/orders";
          ...
          <Container id="details">
            ...
            <Filter>
              {/* <FilterTitle>Delivery Time</FilterTitle>
                <FilterSize onChange={(e) => setTime(e.target.value)}>
                <FilterSizeOption>06:00 PM</FilterSizeOption>
                <FilterSizeOption>10:00 PM</FilterSizeOption>
              </FilterSize> */}
            </Filter>
            {/* <Note>
                <SummaryTitle>NOTE</SummaryTitle>
                <li>
                  Our services are currently available only in Sultanpur,
                  U.P.(228118), upto 9:45 PM only.
                </li>
                <li>
                  Product received might be different from the image. For exact
                  cake order before 7:45 PM.
                </li>
              </Note> */}
            {/* <form onChange={(e) => setInfo(e.target.value)}>
