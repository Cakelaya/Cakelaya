  ...
  return (
    <>
      ...
      <Content style={{ border: "none" }}>
        ...
        <Context>
          <b>Note:</b> Our Privacy Policy is subject to change at any time without
          notice. To make sure you are aware of any changes, please review this
          Privacy Policy Page periodically. By visiting this website you agree
          to be bound by the terms and conditions of this Privacy Policy. If you
          do not agree please do not use or access our Website. By mere use of
          the Website, you expressly consent to our use and disclosure of your
          ...
          possible.<br></br> We use regular Malware Scanning. Your personal
          ...
          <br></br> <b>Do we use ‘cookies’?</b> <br></br> Yes. Cookies are small files
          that a site or its service provider transfers to your computer’s hard
          drive through your Web browser (if you allow) that enable the site’s
          ...
          us remember and process the items in our shopping cart. They are also
          ...
          experiences and tools in the future. We use cookies to: Help remember
          and process the items in the shopping cart. Understand and save user’s
          ...
          off all cookies. You do this through your browser settings. Since the
          ...
          some features will be disabled. It won’t affect the user’s experience
          make your site experience more efficient and may not function
          properly. However, you will still be able to place the orders.{" "}
          <br></br> <br></br> <b>Third-Party Disclosure</b> <br></br> We do not
          sell, trade, or otherwise transfer to outside parties your Personally
          Identifiable Information. <br></br> <br></br> <b>Third-Party Links</b>{" "}
          <br></br> We do not include or offer third-party products or services
          ...
          place to provide a positive experience for users.<br></br> <b>Link:</b>{" "}
          ...
          <br></br> <br></br> <b> We collect your Email Address to: </b> <br></br> Send
          information, respond to inquiries, and/or other requests or questions.
          Process orders and send information and updates about orders. Send you
          additional information related to your product and/or service. Market
          to our mailing list or continue to send emails to our clients after
          the original transaction has occurred.<br></br> We also allow users to
          unsubscribe by using the link at the bottom of each email. If at any
          time you would like to unsubscribe from receiving future emails, you
          can email us at <a href="mailto:support@cakelaya.com" ><b>support@cakelaya.com.</b></a> <br></br> <br></br>
          <b>Contacting Us</b>
          ...
          <br></br> <br></br> Your data stored with us is 100% safe as well as
          secured. We guarantee that your data or details, whether it be related
          to logging in or payment, won't be leaked under any circumstances.
          They are completely confidential. Even anyone at Cakeलाया ?, can't
          look out for any details. For us, the safety and security of the user
          are of utmost priority. At any point, if the user feels, that they
          want to remove their data from our database, they can mail us at our
          official email or contact us at the numbers mentioned below. We take
          strict actions against any security or safety breaches at our
          organisation. We believe that customers are next to god, and believe
          in providing them with the safest and most hassle-free experience.
          Your feedback will help us improve our services. Feel free to fill out
          the google form attached below, to give your feedback about our
          services. We respect your privacy and anonymity, and thus while
          filling out the form you won't be asked to enter your name/phone
          number/email ID or any personal details. For any queries, feel free to
          write to us at our official mail. Usually, we reply to emails within
          48 hours. Sometimes, it may take more than that in case of high
          demand.
          <br />          
        </Context>
      </Content>
